...
syn keyword javaScriptCommentCustom    SECTION contained
syn match   javaScriptLineComment      "\/\/.*" contains=@Spell,javaScriptCommentTodo,javaScriptCommentCustom
syn match   javaScriptCommentSkip      "^[ \t]*\*\($\|[ \t]\+\)"
syn region  javaScriptComment	       start="/\*"  end="\*/" contains=@Spell,javaScriptCommentTodo,javaScriptCommentCustom
...
hi def link javaScriptCommentCustom		cOctalZero
