...
syn keyword	cDone		contained DONE
syn keyword	cFinished		contained FINISH FINISHED
...
syn cluster	cCommentGroup	contains=cTodo,cBadContinuation,cDone,cFinished
...
hi def link cDone   Question
hi def link cFinished   Directory
